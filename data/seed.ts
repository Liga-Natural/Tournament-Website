...
export const galleryImages: GalleryImageRecord[] = [
  ...
  },
  {
    id: "g21",
    eventId: "ev-2026",
    url: "/gallery/2026-premier-champions-huddle.jpg",
    altEn: "Negronis FC lifting the Premier Division trophy",
    altEs: "Negronis FC levantando el trofeo de la Division Premier",
    caption: "Premier Division — Champions",
    orientation: "square",
    accentColor: "gold",
  },
  {
    id: "g22",
    eventId: "ev-2026",
    url: "/gallery/2026-keeper-diving-save.jpg",
    altEn: "Goalkeeper diving to make a save",
    altEs: "Portero se lanza para hacer una atajada",
    caption: "Match action",
    orientation: "portrait",
    accentColor: "navy",
  },
  {
    id: "g23",
    eventId: "ev-2026",
    url: "/gallery/2026-volley-strike.jpg",
    altEn: "Player striking a volley mid-air",
    altEs: "Jugador rematando de volea en el aire",
    caption: "Match action",
    orientation: "portrait",
    accentColor: "gold",
  },
  {
    id: "g24",
    eventId: "ev-2026",
    url: "/gallery/2026-open-field-run.jpg",
    altEn: "Player running onto the ball in open field",
    altEs: "Jugador corriendo hacia el balon en campo abierto",
    caption: "Match action",
    orientation: "portrait",
    accentColor: "navy",
  },
  {
    id: "g25",
    eventId: "ev-2026",
    url: "/gallery/2026-match-challenge.jpg",
    altEn: "Players challenging for the ball",
    altEs: "Jugadores disputando el balon",
    caption: "Match action",
    orientation: "portrait",
    accentColor: "gold",
  },
